<div class="fixed z-20 w-11/12 max-w-sm bottom-4 md:p-2 right-4 alert-toast md:w-full" id="toast">
  ...
  <label class="flex items-start justify-between w-full p-2 text-sm text-white bg-gray-800 rounded shadow-lg cursor-pointer sm:p-4 close" title="close" for="footertoast">
    {{ $slot }}
