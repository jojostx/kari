    ...
    <div class="space-y-6">
        ...
        <div class="p-6 bg-white border rounded-lg shadow-sm">
            ...
            <div class="flex flex-wrap items-center justify-start gap-4">
                <button wire:click="save" type="submit" class="inline-flex items-center justify-center px-4 font-medium tracking-tight text-white bg-gray-900 rounded-lg shadow focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset hover:bg-gray-700 focus:bg-gray-800 focus:ring-offset-gray-700 h-9 focus:ring-white">
                    <span>Save</span>
                </button>
