        ...
        <nav class="flex-1 py-6 overflow-y-auto">
            <ul class="px-6 space-y-6">
                ...
                <li>
                    ...
                    <ul class="mt-2 -mx-3 space-y-1 text-sm">
                        <li>
                            <a href="{{ route('admin.account.settings.index') }}" class="flex items-center gap-3 px-3 py-2 font-medium @if (request()->routeIs('admin.account.settings.index'))  bg-gray-800 text-white hover:text-white @else hover:bg-gray-500/5 focus:bg-gray-500/5 @endif transition rounded-lg">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
