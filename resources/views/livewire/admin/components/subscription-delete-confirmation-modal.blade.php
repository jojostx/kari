<form wire:submit.prevent="confirm">
    <div x-cloak x-data="{ isOpen: false }" x-on:open-subscription-delete-modal.window="isOpen = true" x-on:close-subscription-delete-modal.window="isOpen = false" role="dialog" aria-modal="true" class="block" aria-label="confirmation modal">
