            ...
            <div class="w-full max-w-sm p-2 mx-auto space-y-2 bg-white cursor-default rounded-xl">
                ...
                <div class="px-4 py-2">
                    <div class="grid gap-2 grid-cols-[repeat(auto-fit,minmax(0,1fr))]">
                        ...
                        <button wire:click="approve" wire:loading.disabled type="submit" @error('paayment.refcode') 'disabled' @enderror class="inline-flex items-center justify-center px-4 font-medium tracking-tight text-white rounded-lg shadow disabled:bg-gray-800 focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset h-9 focus:ring-white bg-danger-600 hover:bg-danger-500 focus:bg-danger-700 focus:ring-offset-danger-700">
                            <span>Confirm</span>
                        </button>
                    </div>
                </div>
