<div class="py-14">
    <div class="flex flex-col items-center w-10/12 mx-auto">
        ...
        <div id="feedback_Form" class="flex flex-col items-center justify-center mb-4">
            <div class="flex mb-4">
                <input type="radio" wire:model.defer="type" name="type" value="1" id="positive" class="hidden">
                ...
                <input type="radio" wire:model.defer="type" name="type" value="0" id="negative" class="hidden">
